 ...
 * 1) Set a break point in IrisObjectScriptGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class IrisObjectScriptGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("iris-object-script") // use this codegen library
              ...
              .setOutputDir("out/iris-object-script"); // output directory
